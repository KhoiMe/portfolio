            ...
            <div className="w-full text-white bg-[#222222] py-16 px-4" id="projects" >
                <div className="max-w-[1240px] mx-auto flex">
                    <div className="project-card max-w-xl bg-white shadow dark:bg-[#141414] dark:border-gray-700 mx-auto ease-in-out duration-500 hover:scale-110">
                        <a href="https://tumasco.com/index.php/tienda" target='_blank'>
                        ...
                        <div className="p-5">
                            ...
                            <a href="https://tumasco.com/index.php/tienda" target='_blank' className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white rounded-lg hover:bg-gray-800 focus:ring-4 focus:outline-none">
                                Go to Site
