...
function KnowMe() {
    return (
        <>
            <div className="w-full text-white bg-[#141414] py-16 px-4" id="whoami">
                <div className="max-w-[1240px] mx-auto grid md:grid-cols-2">
                    ...
                    <div className='flex flex-col justify-center'>
                        ...
                        <h1 className='font-title mx-8 md:text-4xl sm:text-3xl text-3xl py-2'>Life's more than time passing by</h1>
